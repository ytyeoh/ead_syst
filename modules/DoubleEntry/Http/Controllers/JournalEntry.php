...
class JournalEntry extends Controller
{
    ...
    public function index()
    {
        ...
        return view('double-entry::journal-entry.index', compact('journals', 'start_date', 'end_date'));
    }
    ...
    public function create()
    {
        ...
        return view('double-entry::journal-entry.create', compact('accounts', 'currency'));
    }
    ...
    public function edit(Journal $journal_entry)
    {
        ...
        return view('double-entry::journal-entry.edit', compact('journal', 'accounts', 'currency'));
    }
